...
#######################################
    ...
    * req_1 : "Doctor" should know any changes in state of "Patient" 
    * req_2 : "Doctor" should *observe* any changes in state of "Patient" 
    * req_3 : "Doctor" should *update* when is occured any changes in state of "Patient" 
